function [fwd_mesh,pj_error] = reconstruct_stnd_cw_spatial(fwd_mesh,...
                                                recon_basis,...
                                                data_fn,...
                                                iteration,...
                                                lambda,...
...
%						  filter_n)
%
% Reconstruction program for standard meshes using soft priori
%
...
%   Hess(1:end/2,1:end/2) = Hess(1:end/2,1:end/2) + (LtL.*reg_kappa);
  ...
  clear foo Hess Hess_norm tmp data_diff G reg_*
