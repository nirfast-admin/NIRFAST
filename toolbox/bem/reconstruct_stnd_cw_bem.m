function [fwd_mesh,pj_error] = reconstruct_stnd_cw_bem(fwd_mesh,...
                                                data_fn,...
                                                iteration,...
                                                lambda,...
                                                output_fn,...
...
% [fwd_mesh,pj_error] = reconstruct_stnd_cw_bem(fwd_mesh,...
%                                        data_fn,...
%                                        iteration,...
%                                        lambda,...
%                                        output_fn,...
%                                        filter_n)
%                                            
% Reconstruction program for standard bem meshes - cw
%
