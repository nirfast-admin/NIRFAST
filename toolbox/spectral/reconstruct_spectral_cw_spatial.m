function [fwd_mesh,pj_error] = reconstruct_spectral_cw_spatial(fwd_mesh,...
                                                            recon_basis,...
                                                            data_fn,...
                                                            iteration,...
                                                            lambda,...
...
% [fwd_mesh,pj_error] = reconstruct_spectral_cw_spatial(fwd_mesh,...
%                                                    recon_basis,...
%                                                    data_fn,...
%                                                    iteration,...
%                                                    lambda,...
...
%                                                    wv_array)
%  
% Soft priori spectral reconstruction
%
...
% wv_array is optional wavelength array (e.g. [661 705 735])
...
%   recon_mesh.sp = recon_mesh.sp + foo_sp;
  ...
  [recon_mesh.conc] = ...
      constrain_val(recon_mesh, recon_mesh.conc,fwd_mesh.chromscattlist);
